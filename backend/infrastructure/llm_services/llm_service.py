...
from core.config.character_config import (CHARACTER_FALLBACK_TEMPLATE,
...
def get_llm_service(backend_type, config):
    if backend_type == 'lmstudio':
        ...
        from infrastructure.llm_services.ollama_service import OllamaService
...
from infrastructure.llm_services.lmstudio_service import LMStudioService  # noqa: F401
from infrastructure.llm_services.ollama_service import OllamaService  # noqa: F401
from infrastructure.llm_services.openai_service import OpenAIService  # noqa: F401
