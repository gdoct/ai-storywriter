...
CREATE TABLE llm_provider_presets (
    ...
    created_at TEXT DEFAULT CURRENT_TIMESTAMP,
    updated_at TEXT DEFAULT CURRENT_TIMESTAMP
, backend_type TEXT NOT NULL DEFAULT 'text');
...
CREATE TABLE settings (
            ...
            created_at TEXT DEFAULT CURRENT_TIMESTAMP,
            updated_at TEXT DEFAULT CURRENT_TIMESTAMP, deprecated INTEGER DEFAULT 1,
            FOREIGN KEY(user_id) REFERENCES users(id)
        );
...
CREATE TABLE user_preferences (
    ...
    last_name TEXT,
    created_at TEXT DEFAULT CURRENT_TIMESTAMP,
    updated_at TEXT DEFAULT CURRENT_TIMESTAMP, show_thinking INTEGER DEFAULT 0, text_llm_config TEXT, multimodal_llm_config TEXT, image_llm_config TEXT,
    FOREIGN KEY(user_id) REFERENCES users(id),
    UNIQUE(user_id)
);
...
, auth_provider TEXT DEFAULT 'local' CHECK (auth_provider IN ('local', 'google')), google_id TEXT, profile_picture TEXT);
...
INSERT INTO llm_provider_presets VALUES (1, 'openai', 'OpenAI', 'https://api.openai.com/v1', 0, 1.0, '{"default_model": "gpt-4", "temperature": 0.7}', '2025-08-19 19:11:07', '2025-09-10 20:44:20', 'text');
INSERT INTO llm_provider_presets VALUES (2, 'github', 'GitHub Models', 'https://models.inference.ai.azure.com', 0, 1.5, '{"default_model": "gpt-4o", "temperature": 0.7}', '2025-08-19 19:11:07', '2025-09-10 20:44:17', 'text');
INSERT INTO llm_provider_presets VALUES (3, 'lmstudio', 'LM Studio', 'http://localhost:1234/v1', 1, 0.1, '{"url": "http://192.168.32.1:1234", "showThinking": false}', '2025-08-19 19:11:07', '2025-09-10 20:44:25', 'text');
INSERT INTO llm_provider_presets VALUES (4, 'ollama', 'Ollama', 'http://localhost:11434/v1', 0, 0.1, '{"default_model": "llama3.1:8b", "temperature": 0.7}', '2025-08-19 19:11:07', '2025-08-19 19:11:07', 'text');
INSERT INTO llm_provider_presets VALUES (5, 'openai_multimodal', 'OpenAI GPT-4 Vision', 'https://api.openai.com/v1', 0, 2.0, None, '2025-09-13 09:49:15', '2025-09-13 09:49:15', 'multimodal');
INSERT INTO llm_provider_presets VALUES (6, 'lmstudio_multimodal', 'LM Studio (Multimodal)', 'http://localhost:1234/v1', 0, 1.0, None, '2025-09-13 09:49:15', '2025-09-13 09:49:15', 'multimodal');
INSERT INTO llm_provider_presets VALUES (7, 'openai_dalle', 'DALL-E 2/3', 'https://api.openai.com/v1', 0, 5.0, None, '2025-09-13 09:49:15', '2025-09-13 09:49:15', 'image');
INSERT INTO llm_provider_presets VALUES (8, 'stable_diffusion', 'Stable Diffusion API', None, 0, 3.0, None, '2025-09-13 09:49:15', '2025-09-13 09:49:15', 'image');
